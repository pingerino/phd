...
\newacronym{APIC}{APIC}{advanced PIC}
\newacronym{ASID}{ASID}{address space ID}
\newacronym[firstplural={certification authorities (CAs)}]{CA}{CA}{certification authority}
\newacronym{BMK}{BMK}{bare metal kernel}
...
\newacronym{DROPS}{DROPS}{Dresden Real-time OPerating system}
...
\newacronym{IPCP}{IPCP}{immediate priority ceiling protocol}
\newacronym{IRQ}{IRQ}{interrupt request}
\newacronym{ISR}{ISR}{interrupt service routine}
\newacronym{MCP}{MCP}{maximum controlled priority}
...
\newacronym{MSRP}{MSRP}{multiprocessor stack resource policy}
...
\newacronym{OPCP}{OPCP}{original priority ceiling protocol}
\newacronym[firstplural={operating systems (OS)},plural={OSes}]{OS}{OS}{operating system}
...
\newacronym{SRP}{SRP}{stack resource policy}
