...
\documentclass[a4paper,twoside,openright,11pt, bibliography=totocnumbered]{book}
...
\newcommand{\call}     {\texttt{seL4\_Call}\xspace}
\newcommand{\send}     {\texttt{seL4\_Send}\xspace}
\newcommand{\wait}     {\texttt{seL4\_Wait}\xspace}
\newcommand{\nbsend}   {\texttt{seL4\_NBSend}\xspace}
\newcommand{\reply}    {\texttt{seL4\_Reply}\xspace}
\newcommand{\replyrecv}{\texttt{seL4\_ReplyRecv}\xspace}
\newcommand{\yield}    {\texttt{seL4\_Yield}\xspace}
\newcommand{\sendwait} {\texttt{seL4\_SendWait}\xspace}


\newcommand{\replywait}{\texttt{seL4\_ReplyWait}\xspace}
\newcommand{\recv}{\texttt{seL4\_Recv}\xspace}
