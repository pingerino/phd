...
plot arm_file_preempt using 1:($5/arm_clk):($6/arm_clk) with errorlines title "ARM-pre", \
     x86_file_preempt using 1:($5/x86_clk):($6/x86_clk) with errorlines title 'x64-pre', \
     arm_file_coop using 1:($5/arm_clk):($6/arm_clk) with errorlines title "ARM-coop", \
