...
The \gls{POSIX} standard specifies real-time operating systems interfaces~\citep{Harbour_1993} which
...
\citet{Faggioli_2008} provides an implementation of \schedsporadic, which \citet{Stanovic_BWH_2010}
...
\citet{Danish_LW_2011}.  In further work \citet{Stanovic_BW_2011} show that while sporadic servers
