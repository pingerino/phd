...
All of the research OSes that implement reservations have an admission
...
Reservations are a mechanism that can be used to provide isolation, however, all of the kernels
...
priority. A further flag indicated if \gls{PIP} should be implemented, where the servers priority
