...
Priority exchange servers~\citep{Sprunt_SL_89a} allow inactive, high-priority tasks to swap their
...
estimates for a system, which results in a tasks with two {\gls{WCET}} estimates, one very pessimistic one from
...
Scheduling algorithms in this class are distinguished by a \emph{criticality mode-switch} between two or more criticality levels,
...
% TODO asymmetric protection comes out of the blue here
