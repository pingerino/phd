...
\TODO{The data flow scenario is currently not referenced anywhere, but its still relevant as the
model allows it. Figure out how to fit it in.}
...
\TODO{pic of scheduling context donation}
...
the kernel to manage stacks. Active servers make temporal isolation optional, as it is not suitable
for all systems.
...
allow a server to be shared across criticalities. Timeout fault endpoints are specific to the
