...
To prevent this, admission control is restricted to the task that holds the scheduling
...
blocked on resume capabilities could be tracked from the endpoint that facilitated the IPC rendezvous.
