...
\end{minted}
\caption[Refill new and update routine.]{Code to initialise a scheduling context whether it is
    (\code{refill\_update}) or is not (\code{refill\_new}, bound
...
\begin{listing}[b!]
\begin{minted}{c}
void check_budget(sched_context_t *sc, uint64_t usage) {
