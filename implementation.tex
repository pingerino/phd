...
\begin{table}[h]
    ...
    \emph{System Call} & Class         & Donation? \\\midrule
    \send, \nbsend     & sending          & No, unless used on an active resume object. \\
    \call              & sending, receiving & \yes \\
    \wait, \nbwait     & waiting       & \no \\
    \recv, \nbrecv     & waiting       & \yes \\
    \nbsendrecv        & sending, receiving & \yes \\
...
\TODO{describe the new invocations, changed invocations}
...
forwarding a scheduling context.
...
context, scheduling context donation does not occur.
