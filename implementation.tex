...
\end{minted}
\caption[Check budget routine]{Check budget routine used to implement sporadic servers.}
...
\end{minted}
\caption[Split check routine]{Split check routine used to implement sporadic servers.}
