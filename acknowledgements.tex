...
\begin{abstract}
    ...
    % reseachers who have helped at some point or another: Thomas Sewell, Adrian
    % Danis, David Greenaway, Kent McLeod, Yanyan Shen, Luke Mondy, and Hesham Almatary. 
    %
    ...
    % in keeping me sane. 
    %
    % Proof readers: Robert Sison, Peter Chubb, Kara Hatherly, Joel Beeren,  
    %
