...
Results are displayed in \Cref{f:evaluation-smp}.

\begin{figure}[ht] 
    \centering
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics{smp_x64}
        \caption{x64}\label{f:evaluation-smp-x64}       
    \end{subfigure}
    \quad
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics{smp_sabre}
        \caption{Sabre}\label{f:evaluation-smp-sabre}
    \end{subfigure}
...
\begin{figure}[t]
    \centering
    \includegraphics[height=6cm]{ipbench-arch}
...
(YCSB)~\citep{Cooper_STRS_10}.
 ...
 \begin{figure}[t]
    \centering
    \includegraphics[height=6cm]{redis-arch}
