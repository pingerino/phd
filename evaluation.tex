...
\begin{table}[t]\centering
    ...
    \bottomrule
\end{tabularx}
\caption[Active slowpath IPC overhead.]{Active slowpath IPC overhead baseline \selfour compared with MCS. All
values excluding the first two rows shows the baseline performance counter value subtracted
from the MCS performance counter value.} \label{t:slowpath-ipc-micro-active}
\end{table}
