...
The process for returning an error is the same as that for \Cref{e:rollback}, however the server
...
is provided.
        ...
        \item[Extend (Ext.)] simply increases the client's budget on each timeout, which could be
