...
Varying definitions exist in the literature. In the real-time community, much work has been
conducted around a theoretical model introduced by \citet{Vestal_2007}. In this model, a system has
...
different levels of criticality can safely share hardware, and not specifically to the model
presented by \citet{Vestal_2007} and beyond~\citep{Burns_Davis_17}.
...
systems and other services in the kernel, resulting in a large trusted computing base. While there 
is no rule on which services and utilities are included in a microkernel, it is generally a subset
of these. For example, \selfour~\citep{Klein_EHA_etal_09} contains a scheduling, \gls{IPC}; 
