...
an \gls{WCET}, $C_{i}$, and period, $T_{i}$, which represents the minimum inter-arrival time
...
For example, \selfour~\citep{Klein_EHACDEEKNSTW_09} contains a scheduling and \gls{IPC}; 
