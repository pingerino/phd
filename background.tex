...
all tasks are assigned \emph{preemption levels} and all resources are assigned ceilings. A resource
ceiling is derived from the maximum, preemption level of tasks accessing that specific resources.
...
However, for systems with many-cores, spin-lock approaches do not scale beyond a small number (~10)
