...
\Cref{tab:locking} compares the different locking protocols, showing that \gls{PCP} provides the lowest bound on priority inversion; however is also the most complicated to implement.
...
\begin{figure}[h!tb]
	\begin{center}
		\leavevmode
		\includegraphics[width=14cm]{os-microkernel.pdf}
