...
until it is unlocked. However, many variants on locking protocols exist, and not all required mutual 
...
To understand the additional preemptions inherent in \gls{PIP}, consider a task set with $n$ tasks, $\tau_{1}, \ldots, A_{n}$, where each task's priority
